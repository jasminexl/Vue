  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'handle',
          component: resolve => require(['../components/pages/number/handle.vue'], resolve)
        },
        {
          path: 'info',
          component: resolve => require(['../components/pages/number/info.vue'], resolve)
        },
        {
          path: 'cust',
          component: resolve => require(['../components/pages/user/cust.vue'], resolve)
        }
      ]
    }
  ]
