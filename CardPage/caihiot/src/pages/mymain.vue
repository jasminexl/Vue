          ...
          <div class="main-content">
            <div class="main-tab" v-show="hasdata">
              <el-tabs v-model="tabname" @tab-click="handleClick">
                <el-tab-pane label="总体" name="total" v-loading="loading" element-loading-text="拼命加载中">
                  <div class="flex">
                    ...
                    <div class="right-table right-table-total">
                      <el-table :data="tableData" border size="small" :summary-method="getSummaries" show-summary>
                ...
                <el-tab-pane label="中国移动" name="2" v-loading="loading" element-loading-text="拼命加载中">
                  <div class="flex">
                    <div class="left-pie">
                ...
                <el-tab-pane label="中国电信" name="3" v-loading="loading" element-loading-text="拼命加载中">
                  <div class="flex">
                    <div class="left-pie">
      ...
      methods: {
        ...
        loadPie () {
          ...
          if (this.tabname === 'total') {
            ...
            this.pieOption.title.text = '卡量总体占比'
            this.pieOption.colors = ['rgb(247, 163, 92)', 'rgb(144, 237, 125)', 'rgb(124, 181, 236)']
          } else if (this.tabname === '2') {
            type = '2'
            this.pieId = this.pieYD
            this.pieOption.title.text = '卡量移动占比'
            this.pieOption.colors = ['rgb(188, 188, 193)', 'rgb(144, 237, 125)', 'rgb(247, 163, 92)', 'rgb(67, 67, 72)']
          } else if (this.tabname === '1') {
            type = '1'
            this.pieId = this.pieLT
            this.pieOption.title.text = '卡量联通占比'
            this.pieOption.colors = ['rgb(188, 188, 193)', 'rgb(144, 237, 125)', 'rgb(247, 163, 92)', 'rgb(67, 67, 72)']
          } else if (this.tabname === '3') {
            type = '3'
            this.pieId = this.pieDX
            this.pieOption.title.text = '卡量电信占比'
            this.pieOption.colors = ['rgb(188, 188, 193)', 'rgb(144, 237, 125)', 'rgb(247, 163, 92)', 'rgb(67, 67, 72)']
          }
          console.log(this.pieId, this.pieOption)
          //开始加载，请求数据
          this.loading = true
          this.$ajax.get('/caihiot/api-amount/amount/overview', {
            params: {
              cardType: type
            }
          })
