      ...
      <section class="last">
        ...
        <div class="main-content" v-loading="loading" element-loading-text="拼命加载中">
          <table class="halftable">
            ...
            <tr>
              <td class="lefttr">营业执照注册号：</td>
              <td>{{info.companyRegNo}}</td>
            </tr>
            <tr>
              <td class="lefttr">营业执照：</td>
            ...
            <tr>
              ...
              <td v-if="info.authenticStatus == '2'">未认证</td>
              <td v-if="info.authenticStatus == '3'">认证中</td>
              <td v-if="info.authenticStatus == '4'">未通过</td>
            </tr>
            <tr v-if="info.authenticStatus == '1' || info.authenticStatus == '4'">
