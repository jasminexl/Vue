      ...
      <section class="last">
        ...
        <div class="main-content"
          ...
          <table class="halftable">
            ...
            <tr>
              <td class="thirdtr"><span class="colorred">*</span>营业执照注册号：</td>
              <td>
                <div class="righttr">
            ...
            <tr>
              <td class="thirdtr"><span class="colorred">*</span>营业执照：</td>
              <td>
                <!--v-bind:data="{'imgName': cerForm.companyLicense}"-->
                <!--action="http://127.0.0.1:9130/api-user/company/uploadImg"-->
                <div class="righttr">
                  <el-upload
            ...
            <tr>
              <td class="thirdtr"><span class="colorred">*</span>法人身份证正面照：</td>
              <td>
                <el-upload
                  :action="upload.action"
                  :headers="headers"
            ...
            <tr>
              <td class="thirdtr"><span class="colorred">*</span>法人身份证反面照：</td>
              <td>
                <el-upload
                  :action="upload.action"
                  :headers="headers"
    ...
    export default {
      ...
      data () {
        return {
          ...
          //上传图片设置
          upload: {
            action: 'http://localhost:9130/api-img/img/upload',  //上传地址
            limit: 1,  //个数限制
            falseMean: false
          },
            ...
            this.$ajax({
              ...
              .then((res) => {
                ...
                if (res.data.code == '0') {
                  ...
                  // window.location.href = '/home/companyinfo'
                  this.$root.eventHub.$emit('even', 3)
